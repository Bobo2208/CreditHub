          ...
          <Col md={3}>
            ...
            <ul className="list-unstyled small">
              <li>
                <Button
                  variant="link"
                  className="text-primary p-0 text-decoration-none mt-auto align-self-center"
                  onClick={() => navigate("/creditSolutions?tip=fizic")}
                >
              ...
              <li>
                <Button
                  variant="link"
                  className="text-primary p-0 text-decoration-none mt-auto align-self-center"
                  onClick={() => navigate("/creditSolutions?tip=juridic")}
                >
